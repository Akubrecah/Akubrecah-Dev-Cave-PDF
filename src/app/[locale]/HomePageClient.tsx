              ...
              {categoryOrder.map((category) => {
                ...
                return (
                  <Link
                    ...
                    className="group"
                  >
                    <Card className="p-5 h-full glass-card hover:bg-[hsl(var(--color-primary)/0.05)] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-[hsl(var(--color-border)/0.6)]">
